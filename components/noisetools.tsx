...
export default function Noisetools(props:any){
    ...
    const [receiverData, setReceiverData] = useState(
        { distFromSource: 20, height: 2, fromRight: 150},
    );
    ...
    const [sourceMatrix, setSourceMatrix] = useState(
        `matrix(1 0 0 1 ${getObjectCoord(FIELD_OBJECT.Source, "X")} ${getObjectCoord(FIELD_OBJECT.Source, "Y")})`,
    );
    ...
    const [sourceArrowPts, setSourceArrowPts] = useState(
        `${getObjectCoord(FIELD_OBJECT.Source, "X")}, 5, ${getObjectCoord(FIELD_OBJECT.Source, "X") + 5}, 0, ${getObjectCoord(FIELD_OBJECT.Source, "X") + 5}, 10`,
    );

    const [receiverArrowPts, setrReceiverArrowPts] = useState(
        `${getObjectCoord(FIELD_OBJECT.Receiver, "X") - 5}, 0, ${getObjectCoord(FIELD_OBJECT.Receiver, "X") - 5}, 10, ${getObjectCoord(FIELD_OBJECT.Receiver, "X") - 5 + 5}, 5`,
    );

    const [sourceHUpArrowPts, setSourceHUpArrowPts] = useState(
        `${sourceData.fromLeft - (pxPerMeter/2)}, ${getObjectCoord(FIELD_OBJECT.Source, "Y")}, 
        ${sourceData.fromLeft - (pxPerMeter/2) - 5}, ${getObjectCoord(FIELD_OBJECT.Source, "Y") + 5}, 
        ${sourceData.fromLeft - (pxPerMeter/2) + 5}, ${getObjectCoord(FIELD_OBJECT.Source, "Y") + 5} 
        `,
    );

    const [sourceDUpArrowPts, setSourceDUpArrowPts] = useState(
        `${sourceData.fromLeft - (pxPerMeter/2)}, ${getObjectCoord("RULER-BACKGROUND", "Y")}, 
        ${sourceData.fromLeft - (pxPerMeter/2) - 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5}, 
        ${sourceData.fromLeft - (pxPerMeter/2) + 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5} 
        `,
    );
    ...
    const [receiverHUpArrowPts, setReceiverHUpArrowPts] = useState(
        ...
        ${getObjectCoord(FIELD_OBJECT.Receiver, "X") - 5}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y") + 5}, 
        ${getObjectCoord(FIELD_OBJECT.Receiver, "X") + 5}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y") + 5} 
        `,
    );
    ...
    const [receiverHDnArrowPts, seReceiverHDnArrowPts] = useState(
        ...
        ${getObjectCoord(FIELD_OBJECT.Receiver, "X") - 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5}, 
        ${getObjectCoord(FIELD_OBJECT.Receiver, "X") + 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5} 
        `,
    );
    ...
    const [receiverPickerArrowPts, setReceiverPickerArrowPts] = useState(
        `${getObjectCoord(FIELD_OBJECT.Receiver, "X")}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y")}, 
        ${getObjectCoord(FIELD_OBJECT.Receiver, "X") - 7}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y") + 7}, 
        ${getObjectCoord(FIELD_OBJECT.Receiver, "X") + 7}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y") + 7}`,
    );
    ...
    const [barrier1HArrowPts, setBarrier1HArrowPts] = useState({
        up: `${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier1, "Y")}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") - 5}, ${getObjectCoord(FIELD_OBJECT.Barrier1, "Y") + 5}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") + 5}, ${getObjectCoord(FIELD_OBJECT.Barrier1, "Y") + 5} 
        `, 
        down: `${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, ${getObjectCoord("RULER-BACKGROUND", "Y")}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") - 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") + 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5} 
        `,
    });
    ...
    const [barrier2HArrowPts, setBarrier2HArrowPts] = useState({
        up: `${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y")}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") - 5}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y") + 5}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 5}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y") + 5} 
        `,
        down: `${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, ${getObjectCoord("RULER-BACKGROUND", "Y")}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") - 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 5}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 5} 
        `,
    });
    ...
    const [barrier2PickerArrowPts, setBarrier2PickerArrowPts] = useState(
        ...
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") - 7}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y") + 7}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 7}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y") + 7} 
        `
    );
    ...
    const [barrierEffectAreaPts, setBarrierEffectAreaPts] = useState({
        Ba1:`${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier1, "Y")},
        ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") + 200}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 2},
        ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") + 200}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 2},
        ${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 2}`,
        
        Ba2:`${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y")}, 
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 200}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 2},
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 200}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 2},
        ${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, ${getObjectCoord("RULER-BACKGROUND", "Y") - 2}`,

        leftRulerStart: sourceData.fromLeft,
        leftRulerEnd: getObjectCoord(FIELD_OBJECT.Barrier1, "X"),
        leftRulerStartArrowPts:`${sourceData.fromLeft + 5}, 2, ${sourceData.fromLeft}, 5, ${sourceData.fromLeft + 5}, 8`,
        leftRulerEndArrowPts:`${getObjectCoord(FIELD_OBJECT.Barrier1, "X") - 5}, 2, ${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, 5, ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") - 5}, 8`,
        midRulerStart: getObjectCoord(FIELD_OBJECT.Barrier1, "X"),
        midRulerEnd: getObjectCoord(FIELD_OBJECT.Barrier2, "X"),
        midRulerStartArrowPts:`${getObjectCoord(FIELD_OBJECT.Barrier1, "X") + 5}, 2, ${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, 5, ${getObjectCoord(FIELD_OBJECT.Barrier1, "X") + 5}, 8`,
        midRulerEndArrowPts:`${getObjectCoord(FIELD_OBJECT.Barrier2, "X") - 5}, 2, ${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, 5, ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") - 5}, 8`,
        rightRulerStart: getObjectCoord(FIELD_OBJECT.Barrier2, "X"),
        rightRulerEnd: fieldData.width - sourceData.fromLeft,
        rightRulerLength: barrier1Data.distFromSource - barrier2Data.distFromSource ,
        rightRulerStartArrowPts:`${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 5}, 2, ${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, 5, ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 5}, 8`,
        rightRulerEndArrowPts:`${fieldData.width - sourceData.fromLeft - 5}, 2, ${fieldData.width - sourceData.fromLeft}, 5, ${fieldData.width - sourceData.fromLeft - 5}, 8`,
    });

    const [linePathSToR, setLinePathSToR] = useState(
        `${getObjectCoord(FIELD_OBJECT.Source, "X")}, ${getObjectCoord(FIELD_OBJECT.Source, "Y")}, ${getObjectCoord(FIELD_OBJECT.Receiver, "X")}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y")}`
    );    

    let captured = useRef(PICKERS.None);

    const [ba1Transform, setBa1Transform] = useState(
        `translate(${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier1, "Y")}) rotate(270)`
    );

    const [ba2Transform, setBa2Transform] = useState(
        `translate(${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y")}) rotate(270)`
    );

    const [recvTransform, setRecvTransform] = useState(
        `translate(${getObjectCoord(FIELD_OBJECT.Receiver, "X")}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y") + 7}) rotate(270)`
    );
    
    let wavesDist = [];
    let field
    let swaveWidthDistLables:number[] = [];
    let rulerWidthDistLables = useRef<number[]>([]);
    ...
    useEffect(() => {
        setSourceMatrix(`matrix(1 0 0 1 ${getObjectCoord(FIELD_OBJECT.Source, "X")} ${getObjectCoord(FIELD_OBJECT.Source, "Y")})`,);
    ...
    useEffect(() => {
        ...
        setBa1Transform(`translate(${getObjectCoord(FIELD_OBJECT.Barrier1, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier1, "Y")}) rotate(270)`);
    ...
    useEffect(() => {
        setBarrier2HArrowPts({
            ...
            ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") - 5}, ${fieldData.height - rulerAreaHight - 5}, 
            ${getObjectCoord(FIELD_OBJECT.Barrier2, "X") + 5}, ${fieldData.height - rulerAreaHight - 5} 
            `,
        });

        setBa2Transform(`translate(${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, ${getObjectCoord(FIELD_OBJECT.Barrier2, "Y")}) rotate(270)`);
        setBarrierEffectArea();
    ...
    function setLineSourceToReceiver(){
        ...
        let leftBarrier = getObjectCoord(FIELD_OBJECT.Barrier1, "X") <= getObjectCoord(FIELD_OBJECT.Barrier2, "X") ? FIELD_OBJECT.Barrier1 : FIELD_OBJECT.Barrier2;
        let rightBarrier = getObjectCoord(FIELD_OBJECT.Barrier1, "X") <= getObjectCoord(FIELD_OBJECT.Barrier2, "X") ? FIELD_OBJECT.Barrier2 : FIELD_OBJECT.Barrier1;
        let sTorLeft = getLineEquationByPos({x:getObjectCoord(FIELD_OBJECT.Source, "X"), y:getObjectCoord(FIELD_OBJECT.Source, "Y")}, {x:getObjectCoord(rightBarrier, "X"), y:getObjectCoord(rightBarrier, "Y")});
        let ptMid = "";
        let tmpX = 0;
        let tmpY = 0;
        let isEnd = false;
        ...
        if(!isEnd){
            sTorEq = getLineEquationByPos({x:tmpX, y:tmpY}, {x:getObjectCoord(FIELD_OBJECT.Receiver, "X"), y:getObjectCoord(FIELD_OBJECT.Receiver, "Y")});
        ...
        setLinePathSToR(
            `${getObjectCoord(FIELD_OBJECT.Source, "X")}, ${getObjectCoord(FIELD_OBJECT.Source, "Y")}, ${ptMid} ${getObjectCoord(FIELD_OBJECT.Receiver, "X")}, ${getObjectCoord(FIELD_OBJECT.Receiver, "Y")}`
        );
    }
    ...
    function setBarrierEffectArea(){
        ...
        let leftBarrier = getObjectCoord(FIELD_OBJECT.Barrier1, "X") <= getObjectCoord(FIELD_OBJECT.Barrier2, "X") ? barrier1Data : barrier2Data;
        let rightBarrier = getObjectCoord(FIELD_OBJECT.Barrier1, "X") <= getObjectCoord(FIELD_OBJECT.Barrier2, "X") ? barrier2Data : barrier1Data;

        let leftBarrierName = getObjectCoord(FIELD_OBJECT.Barrier1, "X") <= getObjectCoord(FIELD_OBJECT.Barrier2, "X") ? FIELD_OBJECT.Barrier1 : FIELD_OBJECT.Barrier2;
        let rightBarrierName = getObjectCoord(FIELD_OBJECT.Barrier1, "X") <= getObjectCoord(FIELD_OBJECT.Barrier2, "X") ? FIELD_OBJECT.Barrier2 : FIELD_OBJECT.Barrier1;
        ...
        setBarrierEffectAreaPts({
            ...
            ${fieldData.width}, ${getObjectCoord("RULER-BACKGROUND", "Y")},
            ${getObjectCoord(FIELD_OBJECT.Barrier2, "X")}, ${getObjectCoord("RULER-BACKGROUND", "Y")}`,

            leftRulerStart: sourceData.fromLeft,
            leftRulerEnd: getObjectCoord(leftBarrierName, "X"),
            leftRulerStartArrowPts:`${sourceData.fromLeft + 5}, 2, ${sourceData.fromLeft}, 5, ${sourceData.fromLeft + 5}, 8`,
            leftRulerEndArrowPts:`${getObjectCoord(leftBarrierName, "X") - 5}, 2, ${getObjectCoord(leftBarrierName, "X")}, 5, ${getObjectCoord(leftBarrierName, "X") - 5}, 8`,
            midRulerStart: getObjectCoord(leftBarrierName, "X"),
            midRulerEnd: getObjectCoord(rightBarrierName, "X"),
            midRulerStartArrowPts:`${getObjectCoord(leftBarrierName, "X") + 5}, 2, ${getObjectCoord(leftBarrierName, "X")}, 5, ${getObjectCoord(leftBarrierName, "X") + 5}, 8`,
            midRulerEndArrowPts:`${getObjectCoord(rightBarrierName, "X") - 5}, 2, ${getObjectCoord(rightBarrierName, "X")}, 5, ${getObjectCoord(rightBarrierName, "X") - 5}, 8`,
            rightRulerStart: getObjectCoord(rightBarrierName, "X"),
            rightRulerEnd: fieldData.width - receiverData.fromRight,
            rightRulerLength: receiverData.distFromSource - rightBarrier.distFromSource,
            rightRulerStartArrowPts:`${getObjectCoord(rightBarrierName, "X") + 5}, 2, ${getObjectCoord(rightBarrierName, "X")}, 5, ${getObjectCoord(rightBarrierName, "X") + 5}, 8`,
            rightRulerEndArrowPts:`${fieldData.width - receiverData.fromRight - 5}, 2, ${fieldData.width - receiverData.fromRight}, 5, ${fieldData.width - receiverData.fromRight - 5}, 8`,
        });

        console.log(`leftRuler = [${barrierEffectAreaPts.leftRulerStart}, ${barrierEffectAreaPts.leftRulerEnd}] midRuler = [${barrierEffectAreaPts.midRulerStart}, ${barrierEffectAreaPts.midRulerEnd}] rightRuler = [${barrierEffectAreaPts.rightRulerStart}, ${barrierEffectAreaPts.rightRulerEnd}]`);
    ...
    function calcBarrier1EffectArea() : {newAreaX:number, newAreaY:number} {
        ...
        if(barrier1Data.distFromSource > barrier2Data.distFromSource) {  //Barrier2가 왼쪽에 있다면
            if(calcY >= getObjectCoord(FIELD_OBJECT.Barrier2, "Y") || getObjectCoord(FIELD_OBJECT.Barrier2, "Y") < getObjectCoord(FIELD_OBJECT.Barrier1, "Y")) {
    ...
    function getLineEquation(fromObj:string, toObj:string) : {a:number , b:number, radius:number} {
        let a = 0;
        let b = 0;
        ...
        let newBa1AreaY = getObjectCoord(fromObj, "Y") + Math.sin(radius) * getObjectCoord(fromObj, "X");
    ...
    function getLineEquationByPos(fromObj:{x:number, y:number}, toObj:{x:number, y:number}) : {a:number , b:number, radius:number} {
        let a = 0;
        let b = 0;
    ...
    function onPickerMouseMoveUseRef(e:MouseEvent, cap:number){
        ...
        if(cap === PICKERS.Source){
            if(svg !== null && e.movementY !== 0){
                ...
                if((svgY + 0) <= e.clientY && (svgY + getObjectCoord("RULER-BACKGROUND", "Y")) >= (e.clientY + captuerPos.current.fromBottom))
                { 
                    //newH-= e.movementY / pxPerMeter;
                    newH = Math.round(((getObjectCoord("RULER-BACKGROUND", "Y") - e.clientY - captuerPos.current.fromBottom ) / pxPerMeter) * 10) / 10;   
            ...
            if(svg !== null && (e.movementY !== 0 || e.movementX !== 0)){
                ...
                if((svgX + getObjectCoord(FIELD_OBJECT.Source, "X")) <= e.clientX && (svgX + getObjectCoord(FIELD_OBJECT.Receiver, "X")) >= e.clientX)
                {
                    newD = Math.round(((e.clientX - svg.getClientRects()[0]['x'] - sourceData.fromLeft + captuerPos.current.x) / pxPerMeter) * 10)/10;
                }
            ...
            if(svg !== null && (e.movementY !== 0 || e.movementX !== 0)){
                ...
                if((svgX + getObjectCoord(FIELD_OBJECT.Source, "X")) <= e.clientX && (svgX + getObjectCoord(FIELD_OBJECT.Receiver, "X")) >= (e.clientX  + captuerPos.current.fromBottom))
                {
                    newD = Math.round(((e.clientX - svg.getClientRects()[0]['x'] - sourceData.fromLeft  + captuerPos.current.x) / pxPerMeter) * 10)/10;  
                }
    ...
    return (
        <WindowBase closeFunc={props.closeFunc} id={props.id} title="Noise Tools UI Implementation">
            ...
            onMouseUp={onSvgMouseUp}>
                ...
                <g id="ba_effect_area">
                    <g id="ba1_effect_area" >
                        <polygon points={barrierEffectAreaPts.Ba1} stroke="#000000" fill="#000000" strokeWidth="0" fillOpacity="12.5%" />
                    </g>
                    <g id="ba2_effect_area" >
                        <polygon points={barrierEffectAreaPts.Ba2} stroke="#000000" fill="#000000" strokeWidth="0" fillOpacity="12.5%" />
                    </g>
                </g>
                ...
                <g id="ruler_area">
                    <g transform={rulerAreaMatrix} >
                        ...
                        <g id="ruler_dist_left" transform="matrix(1 0 0 1 0 15)" >
                            <g>
                                <polygon id="left_dist_st" points={barrierEffectAreaPts.leftRulerStartArrowPts} fill="#000000" />
                                <line id="left_dist" 
                                    x1={barrierEffectAreaPts.leftRulerStart + 5} y1="5" 
                                    x2={barrierEffectAreaPts.leftRulerEnd - 5} y2="5" stroke="#000000" strokeWidth="1"
                                />
                                <polygon id="left_dist_ed" points={barrierEffectAreaPts.leftRulerEndArrowPts} fill="#000000" />
                            </g>
                            <g>
                                <polygon id="mid_dist_st" points={barrierEffectAreaPts.midRulerStartArrowPts} fill="#000000" />
                                <line id="mid_dist" 
                                    x1={barrierEffectAreaPts.midRulerStart + 5} y1="5" 
                                    x2={barrierEffectAreaPts.midRulerEnd - 5} y2="5" stroke="#000000" strokeWidth="1"
                                />
                                <polygon id="mid_dist_ed" points={barrierEffectAreaPts.midRulerEndArrowPts} fill="#000000" />
                            </g>
                            <g>
                                <polygon id="right_dist_st" points={barrierEffectAreaPts.rightRulerStartArrowPts} fill="#000000" />
                                <line id="right_dist"
                                    x1={barrierEffectAreaPts.rightRulerStart + 5} y1="5" 
                                    x2={barrierEffectAreaPts.rightRulerEnd - 5} y2="5" stroke="#000000" strokeWidth="1"
                                />
                                <polygon id="right_dist_ed" points={barrierEffectAreaPts.rightRulerEndArrowPts} fill="#000000" />
                                <rect id="right_dist_box" 
                                    x={barrierEffectAreaPts.rightRulerStart + (barrierEffectAreaPts.rightRulerEnd - barrierEffectAreaPts.rightRulerStart)/2 + rulerWidthDistLables.current[0] * -0.5 } 
                                    y={-3} 
                                    width={rulerWidthDistLables.current[0]} 
                                    height={16} fill="#DDDDDD"></rect>
                                <text className={styles.ruler_dist_s_to_r_text} 
                                    x={barrierEffectAreaPts.rightRulerStart + (barrierEffectAreaPts.rightRulerEnd - barrierEffectAreaPts.rightRulerStart)/2 }
                                    y="5"  textAnchor="middle" alignmentBaseline="middle">{barrierEffectAreaPts.rightRulerLength.toFixed(1)+"m"}</text>
                            </g>
                        </g>
                    ...
                    <g id="ba1_area">
                        <g id="ba1" className={styles.ruler_line} stroke="#000000" fill="#000000" strokeWidth="0" transform="matrix(1 0 0 1 0 0)" >
                            <line id="ba1_line" x1={sourceData.fromLeft + (barrier1Data.distFromSource * pxPerMeter)} y1={fieldData.height - rulerAreaHight - (barrier1Data.height * pxPerMeter)} 
                                x2={getObjectCoord(FIELD_OBJECT.Barrier1, "X")} y2={fieldData.height - rulerAreaHight} strokeWidth="4">
                            </line>
                        </g>
                        <g id="ba1_height_ruler" className={styles.ruler_line} stroke="#000000" fill="#000000" strokeWidth="0" transform="matrix(1 0 0 1 15 0)" >
                            <line id="ba1_height_line" x1={getObjectCoord(FIELD_OBJECT.Barrier1, "X")} y1={getObjectCoord(FIELD_OBJECT.Barrier1, "Y") + 3} 
                                x2={getObjectCoord(FIELD_OBJECT.Barrier1, "X")} y2={fieldData.height - rulerAreaHight} strokeWidth="2">
                            </line>
                ...
                <g className={styles.no_display}>
                    ...
                    <text id="dist1digit" className={styles.ruler_dist_s_to_r_text} x={fieldData.width/2} y="5"  textAnchor="middle" alignmentBaseline="middle">0.0m</text>
                    <text id="dist2digit" className={styles.ruler_dist_s_to_r_text} x={fieldData.width/2} y="5"  textAnchor="middle" alignmentBaseline="middle">00.0m</text>
                    <text id="dist3digit" className={styles.ruler_dist_s_to_r_text} x={fieldData.width/2} y="5"  textAnchor="middle" alignmentBaseline="middle">000.0m</text>
                </g>
            </svg>
